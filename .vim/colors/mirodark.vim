...
if has("gui_running") ||
            \ ((&t_Co == 88 || &t_Co == 256) && !exists("g:mirodark_disable_color_approximation"))
    if !exists("g:mirodark_enable_higher_contrast_mode")
        let s:conf_bclr_hex="000000" " configuration-based background color hexadecimal
        let s:conf_dblk_hex="121212" " configuration-based dark black hexadecimal
        let s:conf_lblk_hex="787878" " configuration-based light black hexadecimal
    else
        let s:conf_bclr_hex="000000"
        let s:conf_dblk_hex="121212"
        let s:conf_lblk_hex="787878"
    endif
	...
	let s:dred_hex="330000"        " dark red hexadecimal      (color 1)
    let s:lred_hex="990000"        " light red hexadecimal     (color 9)
